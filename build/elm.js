...
{
	if (region.R.A === region.W.A)
	{
		return 'on line ' + region.R.A;
	}
	return 'on lines ' + region.R.A + ' through ' + region.W.A;
}
...
var author$project$Experiences$experiences = _List_fromArray(
	[
		...
		{
		G: 'GFI Informatique',
		H: 'Sept. 2015 - May 2017',
		I: '',
		J: _List_fromArray(
			['Javascript', 'PHP', 'Redis', 'WebRTC', 'Python', 'Node.js'])
	},
		{
		G: 'Alcatel-Lucent (apprenticeship)',
		H: 'Sept. 2012 - Sept. 2015',
		I: '',
		J: _List_fromArray(
...
var author$project$Main$initModel = {M: author$project$Experiences$experiences, z: elm$core$Maybe$Nothing, Q: author$project$Skills$initSkills};
...
var author$project$Main$RemoveHighlight = {$: 2};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text(exp.G),
									A2(
									elm$html$Html$p,
									_List_Nil,
									_List_fromArray(
										[
											elm$html$Html$text(exp.H)
										]))
								])),
							A2(
							elm$html$Html$p,
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2(author$project$Main$viewSkillList, model.Q, model.z))
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						author$project$Main$viewExperiences(model.M)
					]))
			]));
};
